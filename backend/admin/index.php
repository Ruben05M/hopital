<?php
    session_start();
    include('assets/inc/config.php'); //fichier de configuration
    
    if (isset($_POST['admin_login'])) {
        $ad_email = $_POST['ad_email'];
        $ad_pwd = $_POST['ad_pwd']; // double encrypt to increase security sha1(md5())
...
<head>
        <meta charset="utf-8" />
        <title>Hospital Appointement System</title>
